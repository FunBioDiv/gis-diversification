...
It is surprising that edge density calculated at 10m resolution are not highly correlated with edge density calculated at 20m or 50m (@fig-coredge). That might indicate the strong influence of artefacts in the 10m calculation. 

The length of semi-natural vs crop (SNC) edge is correlated to the length of the crop (RPG) edge suggesting that more patchy landscapes also have more patchy crop fields.  
